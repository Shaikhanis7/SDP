...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-[8vh] flex flex-row justify-between items-center bg-primary-foreground shadow-sm px-4 sticky top-0 z-10">
      ...
      <div className="w-2/4 h-full flex flex-row justify-center items-center gap-8 hidden md:flex">
        <NavLink to="/jobs">
          <FaBriefcase className="text-primary text-xl cursor-pointer hover:text-accent-foreground transition-colors duration-300" />
        </NavLink>
      ...
      <div className="md:hidden flex items-center gap-4">
        {/* Mobile menu button */}
        <button className="text-primary text-xl cursor-pointer hover:text-accent-foreground">
          <FaBriefcase />
        </button>
        <ModeToggle />
      </div>
